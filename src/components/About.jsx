...
const About = () => {
    ...
    return (
        <section id="features" className={layout.sectionCol}>
            ...
            <div id="Specifications" className={activeTab ? `hidden ${styles.flexCenter} flex flex-col z-0` : `block ${styles.flexCenter} flex flex-col z-0`}>
            ...
            <div id="Description" className={activeTab ? `block ${styles.flexCenter} flex flex-col z-0` : `hidden ${styles.flexCenter} flex flex-col z-0`}>
